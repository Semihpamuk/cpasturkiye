...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      "Kurulum tarafında ise Meta Business Manager, katalog segmentleri, piksel eşleştirmesi gibi teknik adımlar vardır. Bu süreç ilk kez yapan biri için karmaşık olabilir; CPAS Türkiye olarak kurulumun tamamını sizin adınıza yönetiyor, reklamlarınızı 7 iş gününde canlıya alıyoruz.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "5) Anomalileri erken yakalayın. ROAS düşüşleri çoğu zaman ani başlar: bir kreatif yorulur, bir rakip agresif fiyat kırar, bir ürün stok sorunu yaşar. Günlük takip eden satıcı, sorunu 1 günde yakalar; haftalık bakan satıcı 7 günlük bütçeyi yakmış olur. CPAS Türkiye'nin yönetim hizmetinde bu izleme 7/24 sizin yerinize yapılır ve kritik durumlarda aynı gün müdahale edilir.",
    ],
  },
  {
    ...
    content: [
      ...
      "En sık karşılaşılan sorunlar şunlardır: Meta Business Manager hesabının doğrulanmamış olması, ödeme yöntemi eklenmemiş reklam hesabı ve katalog segmentlerinin hatalı yapılandırılması. Bu teknik engeller, özellikle ilk kez kurulum yapanlar için saatler hatta günler alabiliyor. CPAS Türkiye, bu sürecin tamamını sizin adınıza yönetiyor ve yetki onayından Meta bağlantısına kadar her adımı takip ediyor.",
      "Yetki aldıktan sonra ne olur? Meta Business Manager'da bir katalog oluşturmanız, bunu Trendyol'un paylaştığı ürün feed'iyle eşleştirmeniz ve ardından dinamik reklam kampanyaları kurmanız gerekir. Bu aşamalar birbirini izler ve her birinde teknik bir hata, bütçenizin boşa gitmesine yol açabilir. CPAS Türkiye, 7 günlük kurulum hizmetiyle tüm bu süreci uçtan uca yönetir.",
    ],
  },
  {
