    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            "Platform, hizmetin çalışması için gerekli olan zorunlu çerezlerin yanında ziyaret istatistiklerinin ölçülmesi amacıyla Google Analytics 4 analitik çerezlerini, reklam performansının ölçülmesi ve yeniden pazarlama amacıyla Meta Pixel ile Google Ads reklam çerezlerini kullanır. Bu etiketlerin yönetiminde Google Etiket Yöneticisi (Google Tag Manager) kullanılır; etiket yöneticisi kendi başına çerez oluşturmaz. Bu çerezler yalnızca çerez onay bandı üzerinden verdiğiniz açık rıza ile çalıştırılır; onay vermediğiniz takdirde oluşturulmazlar. Analitik ve reklam ölçümü kapsamında işlenen veriler Google Ireland Limited ve Meta Platforms Ireland Limited tarafından yurt dışındaki sunucularda işlenebilir; tarayıcı üzerinden gönderilen bu olaylarda sizi doğrudan tanımlayan bilgiler (ad, e-posta, telefon, fatura verileri) aktarılmaz.",
